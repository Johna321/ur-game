...
function love.load()
  ...
  --loading the images
  greyp = love.graphics.newImage("greyp.png")
  redp = love.graphics.newImage("redp.png")
  greenp = love.graphics.newImage("greenp.png")
  whitep = love.graphics.newImage("whitep.png")
  bluep = love.graphics.newImage("bluep.png")
  ...
  setting = love.graphics.newImage("setting.png")
  chplayer = love.graphics.newImage("chplayer.png")
  p1 = love.graphics.newImage("player1.png")
end
